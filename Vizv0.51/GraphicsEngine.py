...
# =============================================================================
        ...
        self.__Brailler(start, brailleString)

    def __Brailler(self, start, brailleString):
        """ takes in starting point for font and string to write
        naturally fills up the screen as you type """
        startY = start[0] + 3
        startX = start[1]
        ...
        #select the braille font
        self.__ct.select_font_face("blob-braille-double", ca.FONT_SLANT_NORMAL, ca.FONT_WEIGHT_NORMAL)
